...
namespace SharedStopEnabler.StopSelection.Patch
{
    ...
    [HarmonyPatch(
        new Type[] { typeof(Vector3), typeof(ItemClass.Service), typeof(ItemClass.Service), typeof(NetInfo.LaneType), typeof(VehicleInfo.VehicleType), 
            typeof(VehicleInfo.VehicleType), typeof(bool), typeof(bool), typeof(float), typeof(PathUnit.Position), typeof(PathUnit.Position), typeof(float), typeof(float)},
        new ArgumentType[] { ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal,
